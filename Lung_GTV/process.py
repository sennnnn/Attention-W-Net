...
class train_batch(object):
    def __init__(self,data_block,mask_block,translation,flip,angle,num_class):
    ...
    def get_batch(self,batch_size):
        ...
        for i in range(index,index+batch_size):
            ...
            temp_slice_data,temp_slice_mask = _preprocess_oneslice((one_data_slice,one_mask_slice),\
                self.trans,self.flip,self.angle)
